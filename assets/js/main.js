...
// Make both image and icon clickable for zoom
document.querySelectorAll(".project-content img, .zoom-icon").forEach((el) => {
  el.addEventListener("click", function () {
    let imgSrc =
      this.tagName === "IMG" ? this.src : this.previousElementSibling.src;
